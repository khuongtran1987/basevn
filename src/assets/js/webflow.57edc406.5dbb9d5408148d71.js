(() => {
  var e = {
      6456: function (e, t) {
        ...
        class c {
          ...
          destroy() {
            this.cleanMemoryGarbage(),
              this.container && (a.delete(this.container), i.delete(this.container));
          }
          async load({
            container: e,
            src: t,
            ...
            try {
              ...
              let f = e.ownerDocument.defaultView,
                ...
                b = s(f),
                p = new b.Layout({ fit: v ?? b.Fit.Contain, alignment: h ?? b.Alignment.Center }),
                g = {
                  artboard: n,
                  layout: p,
                  autoplay: d,
                  ...
                  onLoadError: () => {
                    this.riveInstanceErrorLoaded ||
                      this.rive.load({ ...g, artboard: void 0, stateMachines: void 0 }),
        ...
        let d = () => Array.from(document.querySelectorAll('[data-animation-type="rive"]')),
          l = async ({
            container: e,
            onLoad: t,
            src: r,
  ...
  var n = r.O(void 0, ['87', '891', '812', '471'], function () {
    return r(4335);
  });
  n = r.O(n);
})();
